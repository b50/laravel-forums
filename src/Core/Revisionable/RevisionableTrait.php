<?php namespace LaravelForums\Core\Revisionable;

/**
 * Custom version of
 * https://github.com/VentureCraft/revisionable/blob/master/src/Venturecraft/Revisionable/RevisionableTrait.php
 */
trait RevisionableTrait {
	...
	{
		return Revision::where('revisionable_type', get_called_class())->orderBy('updated_at', $order)->limit($limit)->get();
	}
	...
	{
		return $this->morphMany('LaravelForums\Revisions\EloquentRevision', 'revisionable');
	}

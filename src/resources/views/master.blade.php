<!DOCTYPE HTML>
 <html lang="en">
	...
	<body>
					...
					@if (Auth::check())
						<div id="nav-profile" class="navbar-right">
							...
							<div id="nav-profile-links">
								{{ HTML::uLinkRoute('users.show', Auth::user()->username.' <i class="fa fa-caret-down"></i>', ['user' => Auth::user()->slug]) }}<br>
							</div>
						</div>
					@else
		...
		<hr/>
		<div class="container">
			<div class="pull-left" style="padding-top: 10px">{{ _('laravelforums') }}</div>

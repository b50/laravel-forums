...
use LaravelForums\Forums\Preview;
use LaravelForums\Forums\Topics\Edit\TopicEditor;
...
class EditPostRequest {
	 ...
	 */
	public function __construct(EditPostValidator $validator, Preview $preview, TopicEditor $topic, PostEditor $post,

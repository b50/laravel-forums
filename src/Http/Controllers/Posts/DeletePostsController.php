...
use LaravelForums\Forums\Posts\Delete\PostDeleter;
use LaravelForums\Forums\Posts\Delete\PostDeleterListener;
...
class DeletePostsController extends BasePostsController implements PostDeleterListener {
	...
	public function cantDeleteFirstPost()
	{
		...
		return Redirect::route('forums.posts.delete', ['topicType' => Route::current()->parameter('topicType'),
			'post' => $this->post->id]);
	}

...
use LaravelForums\Forums\Topics\Move\MoveTopicRequest;
use LaravelForums\Forums\Topics\Move\TopicMoverListener;
...
class MoveTopicsController extends BaseController implements TopicMoverListener {
	...
	public function getMove($topicType, $id)
	{
		...
		return \View::make('LaravelForums::forums.move', compact('topic', 'tree'));
	}

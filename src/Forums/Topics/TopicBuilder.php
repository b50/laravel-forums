...
use LaravelForums\Forums\Topics\Read\TopicReadRepoInterface;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;

/**
 * Builds topics
 *
 * @package LaravelForums\Forums\Topics
 */
class TopicBuilder {
	 ...
	 */
	public function __construct(TopicRepoInterface $topic, TopicReadRepoInterface $read, TopicViewCounter $counter,
		TopicSort $sort)
	{

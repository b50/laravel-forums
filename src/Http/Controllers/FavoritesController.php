<?php namespace LaravelForums\Http\Controllers;

use LaravelForums\Forums\Topics\Favorite\FavoriteRepoInterface;
...
class FavoritesController extends BaseController {
	...
	public function getIndex()
	{
		...
		return View::make('LaravelForums::forums.favorites', compact('favorites', 'breadcrumbs'), ['sort' => $this->sort]);
	}
